            ...
            <div class="mainwp-main-content" style="padding-top: 3px;">
                ...
                <div class="ui message info">
                    <i class="close icon mainwp-notice-dismiss" notice-id="mainwp_groups_info"></i>
                        ...
                        <div><?php printf( esc_html__( 'for more information check the %1$sKnowledgebase %2$s.', 'mainwp' ), '<a href="hhttps://docs.mainwp.com/sites/management/manage-child-sites#manage-child-site-tags" target="_blank">', '</a> <i class="external alternate icon"></i>' ); // NOSONAR - noopener - open safe. ?></div>
                </div>
                <?php } ?>
                <?php
                /**
