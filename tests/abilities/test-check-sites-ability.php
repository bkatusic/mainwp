<?php
/**
 * MainWP CheckSites Ability Tests
 *
 * Tests for the mainwp/check-sites-v1 ability.
 *
...
/**
 * Tests for mainwp/check-sites-v1 ability.
 *
 * @group abilities
...
class Test_CheckSites_Ability extends MainWP_Abilities_Test_Case {
    ...
    public function test_ability_is_registered() {
        ...
        $ability = wp_get_ability( 'mainwp/check-sites-v1' );
        $this->assertNotNull( $ability, 'Ability mainwp/check-sites-v1 should be registered.' );
    }
     ...
     * @return void
     */
    public function test_check_sites_returns_expected_structure() {
        $this->skip_if_no_abilities_api();
        $this->set_current_user_as_admin();

        $site_id = $this->create_test_site( [
            'name' => 'Test Site',
            'url'  => 'https://test-check-sites.example.com/',
        ] );
     ...
     * @return void
     */
    public function test_check_sites_requires_authentication() {
        $this->skip_if_no_abilities_api();
     ...
     * @return void
     */
    public function test_check_sites_requires_manage_options() {
        $this->skip_if_no_abilities_api();
     ...
     * @return void
     */
    public function test_check_sites_validates_input() {
        $this->skip_if_no_abilities_api();
        $this->set_current_user_as_admin();

        $result = $this->execute_ability( 'mainwp/check-sites-v1', [
            'site_ids_or_domains' => 'invalid',
        ] );
     ...
     * @return void
     */
    public function test_check_sites_queues_large_batch() {
        $this->skip_if_no_abilities_api();
        $this->set_current_user_as_admin();
