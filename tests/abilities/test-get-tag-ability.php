<?php
/**
 * Tests for mainwp/get-tag-v1 ability.
 *
 ...
 */
class MainWP_Get_Tag_Ability_Test extends MainWP_Abilities_Test_Case {
	...
	public function test_ability_is_registered() {
		...
		$this->assertArrayHasKey(
			'mainwp/get-tag-v1',
			$abilities,
			'Ability mainwp/get-tag-v1 should be registered.'
		);
	}
	 ...
	 * @return void
	 */
	public function test_get_tag_returns_expected_structure() {
		$this->skip_if_no_abilities_api();
		...
		$this->assertEquals( 'Production Sites', $result['name'] );
	 ...
	 * @return void
	 */
	public function test_get_tag_requires_authentication() {
		$this->skip_if_no_abilities_api();
	 ...
	 * @return void
	 */
	public function test_get_tag_requires_manage_options() {
		$this->skip_if_no_abilities_api();
		$this->setExpectedIncorrectUsage( 'WP_Ability::execute' );
	 ...
	 * @return void
	 */
	public function test_get_tag_validates_input() {
		$this->skip_if_no_abilities_api();
		$this->set_current_user_as_admin();
	 ...
	 * @return void
	 */
	public function test_get_tag_returns_error_for_not_found() {
		$this->skip_if_no_abilities_api();
		$this->set_current_user_as_admin();
