<?php
/**
 * MainWP ActivateSitePlugins Ability Tests
 *
 * Tests for the mainwp/activate-site-plugins-v1 ability.
 *
...
/**
 * Tests for mainwp/activate-site-plugins-v1 ability.
 *
 * @group abilities
 * @group abilities-sites
 */
class Test_ActivateSitePlugins_Ability extends MainWP_Abilities_Test_Case {
    ...
    public function test_ability_is_registered() {
        ...
        $ability = wp_get_ability( 'mainwp/activate-site-plugins-v1' );
        $this->assertNotNull( $ability, 'Ability mainwp/activate-site-plugins-v1 should be registered.' );
    }
     ...
     * @return void
     */
    public function test_activate_site_plugins_returns_expected_structure() {
        $this->skip_if_no_abilities_api();
        $this->set_current_user_as_admin();

        $site_id = $this->create_test_site( [
            'name' => 'Test Site',
            'url'  => 'https://test-activate-site-plugins.example.com/',
        ] );
     ...
     * @return void
     */
    public function test_activate_site_plugins_requires_authentication() {
        $this->skip_if_no_abilities_api();
     ...
     * @return void
     */
    public function test_activate_site_plugins_requires_manage_options() {
        $this->skip_if_no_abilities_api();
     ...
     * @return void
     */
    public function test_activate_site_plugins_validates_input() {
        $this->skip_if_no_abilities_api();
        $this->set_current_user_as_admin();
     ...
     * @return void
     */
    public function test_activate_site_plugins_requires_minimum_child_version() {
        $this->skip_if_no_abilities_api();
        $this->set_current_user_as_admin();
        ...
        $site_id = $this->create_test_site( [
            ...
            'url'     => 'https://test-activate-plugins-outdated.example.com/',
            'version' => '3.0.0',
        ] );
