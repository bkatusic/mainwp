<?php
/**
 * MainWP ReconnectSite Ability Tests
 *
 * Tests for the mainwp/reconnect-site-v1 ability.
 *
...
/**
 * Tests for mainwp/reconnect-site-v1 ability.
 *
 * @group abilities
 * @group abilities-sites
 */
class Test_ReconnectSite_Ability extends MainWP_Abilities_Test_Case {
    ...
    public function test_ability_is_registered() {
        ...
        $ability = wp_get_ability( 'mainwp/reconnect-site-v1' );
        $this->assertNotNull( $ability, 'Ability mainwp/reconnect-site-v1 should be registered.' );
    }
     ...
     * @return void
     */
    public function test_reconnect_site_returns_expected_structure() {
        $this->skip_if_no_abilities_api();
     ...
     * @return void
     */
    public function test_reconnect_site_requires_authentication() {
        $this->skip_if_no_abilities_api();
     ...
     * @return void
     */
    public function test_reconnect_site_requires_manage_options() {
        $this->skip_if_no_abilities_api();
     ...
     * @return void
     */
    public function test_reconnect_site_validates_input() {
        $this->skip_if_no_abilities_api();
        $this->set_current_user_as_admin();
